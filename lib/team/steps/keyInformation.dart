...
import 'package:projectflutter/team/steps/page33data.dart';

import 'keyinformation2.dart';

class keyInformation extends StatefulWidget {
  ...
  @override
  _keyInformationState createState() => _keyInformationState();
}

class _keyInformationState extends State<keyInformation> {
  ...
  void _keyinformationsubmit() {
    if (_formKey.currentState!.validate()) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => keyinformation2(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: _keyinformationsubmit,
                  ),
                ],
              ),
            ),
