...
import 'package:projectflutter/Personal_Data/scientific_expertise.dart';

class qualifications extends StatefulWidget {
  const qualifications({super.key, required String brief});
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => expertise(
            ...
            yearOfGraduation: _endyearCont.hashCode,
